...
# def count_identical(arr_list: list) -> dict:
#     elem_count = {}
#     for elem in arr_list:
#         c = arr_list.count(elem)
#         if c > 1:
#             elem_count[elem] = c
#     return elem_count
...
# elem_c = count_identical(test_list)
...
# identicals = count_identical(test_list1)
# max_value = max(identicals.values())
# freq_key = None
...
# print('The most frequent element:', freq_key)
# print('-' * 50, 'END', '-' * 50)
# print()

# # 18. Написать функию которая находить сумму квадратов
# def sum_of_squares(a: int, b: int) -> int:
#     return a ** 2 + b ** 2

# print('4^2 + 5^2 =', sum_of_squares(4, 5))
# print('-' * 50, 'END', '-' * 50)
# print()
...
# # 20. Написать декоратор для кэширование функции(основная функция ускорение процесса извлечения данных ).
# def cache_func(function):
#     data_history = {}
#     def inner_func(*args):
#         a, b = args
#         key = str(a) + '-' + str(b)
#         if data_history.get(key) is None:
#             print(key, 'is not in history')
#             data_history[key] = function(a, b)
#         else:
#             print(key, 'is in history')
#         return data_history[key]
#     return inner_func
